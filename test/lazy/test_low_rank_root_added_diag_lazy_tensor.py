...
from linear_operator.lazy import LowRankRootAddedDiagLazyTensor, LowRankRootLazyTensor
from linear_operator.test.lazy_tensor_test_case import LazyTensorTestCase, _ensure_symmetric_grad
