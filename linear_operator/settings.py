...
class use_naive_kernel_matrix_sparsification(_feature_flag):
    """
...
class kernel_matrix_sparsification_fraction_non_zero(_value_context):
    """
    Sparsify kernel matrix-vector products if the fraction of non-zero entries is less than or equal to the given
    threshold.
    """
